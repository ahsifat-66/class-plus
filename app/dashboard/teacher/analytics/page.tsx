    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col text-slate-900 dark:text-slate-100 transition-colors">
                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 w-full sm:w-auto">
                  <div className="relative flex-1 sm:flex-initial">
                    ...
                    <input
                      ...
                      className="w-full sm:w-48 rounded-xl border border-slate-200 pl-8 pr-3 py-2 sm:py-1.5 text-xs text-slate-800 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-purple-500/20"
                    />
                  </div>
                  ...
                  {(data.classes || []).length > 1 && (
                    <select
                      ...
                      className="rounded-xl border border-slate-200 px-3 py-2 sm:py-1.5 text-xs text-slate-700 bg-white focus:outline-none focus:ring-2 focus:ring-purple-500/20"
                    >
      ...
      {selectedStudentId && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-150">
          <div className="relative w-full max-w-3xl max-h-[92vh] overflow-y-auto rounded-2xl sm:rounded-3xl bg-white p-4 sm:p-8 shadow-2xl border border-slate-100 space-y-5 sm:space-y-6">
            {/* Modal Header */}
