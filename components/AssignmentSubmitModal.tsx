...
export default function AssignmentSubmitModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="w-full max-w-2xl max-h-[92vh] flex flex-col rounded-3xl border border-slate-200 bg-white shadow-2xl animate-in zoom-in-95 duration-150 overflow-hidden">
        {/* Header */}
        <div className="flex items-center justify-between px-5 py-4 border-b border-slate-100 bg-slate-50/70">
          ...
          <button
            onClick={onClose}
            className="rounded-xl p-2 text-slate-400 hover:bg-slate-200/60 hover:text-slate-600 transition-colors"
          >
            <X className="h-5 w-5" />
          </button>
        </div>
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-5">
          ...
          {error && (
            <div className="flex items-center gap-2 rounded-xl bg-rose-50 p-3 text-xs sm:text-sm text-rose-700 border border-rose-200">
          ...
          <form id="submission-form" onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="rounded-2xl border border-indigo-100 bg-indigo-50/40 p-4 space-y-2">
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="flex-1 text-base sm:text-sm rounded-xl border border-indigo-200 bg-white px-3.5 py-2.5 text-slate-900 placeholder-slate-400 focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/20"
                />
                {driveUrl.trim() && (
                  <a
                    href={driveUrl.trim()}
                    ...
                    className="inline-flex items-center gap-1 shrink-0 rounded-xl bg-indigo-600 px-3 py-2.5 text-xs font-semibold text-white hover:bg-indigo-700 transition-colors shadow-sm"
              ...
              <p className="text-[11px] text-slate-500">
                Please make sure the link access is set to <strong className="text-slate-700 font-semibold">"Anyone with the link can view"</strong> so your instructor can review it.
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              {!attachedFile ? (
                <label
                  ...
                  className="flex flex-col items-center justify-center p-5 rounded-2xl border-2 border-dashed border-slate-300 hover:border-indigo-400 hover:bg-indigo-50/20 transition-all cursor-pointer text-center group"
                >
                  <div className="h-10 w-10 rounded-full bg-slate-100 flex items-center justify-center text-slate-500 group-hover:bg-indigo-100 group-hover:text-indigo-600 transition-colors mb-2">
                    {isProcessingFile ? (
            ...
            <div className="space-y-1.5">
              ...
              <textarea
                ...
                className="w-full font-mono text-base sm:text-xs rounded-2xl border border-slate-300 p-3.5 text-slate-900 focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 leading-relaxed"
              />
            </div>
          </form>
        </div>
        ...
        {/* Footer Actions */}
        <div className="flex items-center justify-end gap-3 px-5 py-4 border-t border-slate-100 bg-slate-50/70">
          <button
            type="button"
            onClick={onClose}
            className="rounded-xl px-4 py-2.5 text-xs sm:text-sm font-medium text-slate-600 hover:bg-slate-200/60 transition-colors"
          >
            Cancel
          </button>
          <button
